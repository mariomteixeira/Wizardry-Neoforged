...
import com.koomplo.wizardry.content.effect.*;
...
public final class EBMobEffects {
    ...
    public static final DeferredObject<MobEffect> TRANSIENCE = mobEffect("transience", () -> new MagicMobEffect(MobEffectCategory.BENEFICIAL, 0) {
        @Override
        public void spawnCustomParticle(net.minecraft.world.level.Level world, double x, double y, double z) {
            com.koomplo.wizardry.api.client.ParticleBuilder.create(com.koomplo.wizardry.setup.registries.client.EBParticles.DUST)
    ...
    public static final DeferredObject<MobEffect> MIND_CONTROL = mobEffect("mind_control", () -> new MagicMobEffect(MobEffectCategory.HARMFUL, 0x320b44) {
        @Override
        public void spawnCustomParticle(net.minecraft.world.level.Level world, double x, double y, double z) {
        }
    });
