...
import com.koomplo.wizardry.content.entity.ArrowRainConstruct;
import com.koomplo.wizardry.content.entity.MeteorEntity;
import com.koomplo.wizardry.content.entity.construct.*;
import com.koomplo.wizardry.content.entity.living.*;
...
import static com.koomplo.wizardry.WizardryMainMod.location;
...
public final class EBEntities {
    ...
    public static final DeferredObject<EntityType<RadiantTotemConstruct>> RADIANT_TOTEM = entity(RadiantTotemConstruct::new, "radiant_totem", MobCategory.MISC, 1, 1, MagicType.CONSTRUCT);
    ...
    public static final DeferredObject<EntityType<com.koomplo.wizardry.content.entity.ShieldEntity>> SHIELD = entity("shield",
            EntityType.Builder.<com.koomplo.wizardry.content.entity.ShieldEntity>of(com.koomplo.wizardry.content.entity.ShieldEntity::new, MobCategory.MISC)
