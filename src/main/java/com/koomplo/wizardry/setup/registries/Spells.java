...
import com.koomplo.wizardry.content.entity.construct.*;
import com.koomplo.wizardry.content.entity.living.IceWraith;
import com.koomplo.wizardry.content.entity.living.LightningWraith;
import com.koomplo.wizardry.content.entity.living.ShadowWraith;
import com.koomplo.wizardry.content.entity.living.StormElemental;
import com.koomplo.wizardry.content.entity.projectile.*;
import com.koomplo.wizardry.content.spell.necromancy.BlockWithSurprise;
import com.koomplo.wizardry.content.spell.DefaultProperties;
import com.koomplo.wizardry.content.spell.abstr.*;
import com.koomplo.wizardry.content.spell.earth.*;
import com.koomplo.wizardry.content.spell.fire.*;
import com.koomplo.wizardry.content.spell.healing.*;
import com.koomplo.wizardry.content.spell.ice.*;
import com.koomplo.wizardry.content.spell.lightning.*;
import com.koomplo.wizardry.content.spell.magic.ForceArrowSpell;
import com.koomplo.wizardry.content.spell.necromancy.*;
import com.koomplo.wizardry.content.spell.sorcery.*;
...
//        ));
        ...
        FREEZING_WEAPON = spell("freezing_weapon", com.koomplo.wizardry.content.spell.ice.FreezingWeapon::new);
        ...
        FROST_BARRIER = spell("frost_barrier", com.koomplo.wizardry.content.spell.ice.FrostBarrier::new);

        DECOY = spell("decoy", () -> new Decoy().soundValues(1, 0.9f, 0.2f));

        BLACK_HOLE = spell("black_hole", () -> new ConstructRangedSpell<>(com.koomplo.wizardry.content.entity.construct.BlackHoleConstruct::new, false))
        ...
        LIGHTNING_HAMMER = spell("lightning_hammer", () -> new ConstructRangedSpell<>(com.koomplo.wizardry.content.entity.construct.HammerConstruct::new, false) {
            @Override
            protected boolean spawnConstruct(com.koomplo.wizardry.api.content.spell.internal.CastContext ctx,
            ...
            @Override
            protected void addConstructExtras(com.koomplo.wizardry.api.content.spell.internal.CastContext ctx,
                                              com.koomplo.wizardry.content.entity.construct.HammerConstruct construct,
        ...
        STORMCLOUD = spell("stormcloud", () -> new ConstructRangedSpell<>(com.koomplo.wizardry.content.entity.construct.StormcloudConstruct::new, false) {
            @Override
            protected void addConstructExtras(com.koomplo.wizardry.api.content.spell.internal.CastContext ctx,
                                              com.koomplo.wizardry.content.entity.construct.StormcloudConstruct construct,
                                              net.minecraft.core.Direction side) {
        ...
        RADIANT_TOTEM = spell("radiant_totem", () -> new ConstructRangedSpell<>(com.koomplo.wizardry.content.entity.construct.RadiantTotemConstruct::new, false) {
            @Override
            protected void addConstructExtras(com.koomplo.wizardry.api.content.spell.internal.CastContext ctx,
                                              com.koomplo.wizardry.content.entity.construct.RadiantTotemConstruct construct,
                                              net.minecraft.core.Direction side) {
        ...
        WITHERING_TOTEM = spell("withering_totem", () -> new ConstructRangedSpell<>(com.koomplo.wizardry.content.entity.construct.WitheringTotemConstruct::new, false) {
            @Override
            protected void addConstructExtras(com.koomplo.wizardry.api.content.spell.internal.CastContext ctx,
                                              com.koomplo.wizardry.content.entity.construct.WitheringTotemConstruct construct,
                                              net.minecraft.core.Direction side) {
                construct.setPos(construct.getX(), construct.getY() + 1.2, construct.getZ());
            }
        }.assignProperties(
        ...
        SHIELD = spell("shield", com.koomplo.wizardry.content.spell.healing.Shield::new);

        SHADOW_WARD = spell("shadow_ward", () -> new com.koomplo.wizardry.content.spell.necromancy.ShadowWard().soundValues(0.6f, 1, 0));

        SIXTH_SENSE = spell("sixth_sense", () -> new SixthSense().soundValues(1, 1.1f, 0.2f));

        THUNDERSTORM = spell("thunderstorm", () -> new com.koomplo.wizardry.content.spell.lightning.Thunderstorm().soundValues(1, 1.7f, 0.2f));

        MIND_CONTROL = spell("mind_control", com.koomplo.wizardry.content.spell.necromancy.MindControl::new);

        METAMORPHOSIS = spell("metamorphosis", () -> new com.koomplo.wizardry.content.spell.necromancy.Metamorphosis().soundValues(0.5f, 1f, 0));
        ...
        RESURRECTION = spell("resurrection", com.koomplo.wizardry.content.spell.healing.Resurrection::new);

        POSSESSION = spell("possession", com.koomplo.wizardry.content.spell.necromancy.Possession::new);

        FORCEFIELD = spell("forcefield", () -> new ConstructSpell<>(com.koomplo.wizardry.content.entity.construct.ForcefieldConstruct::new, false) {
            @Override
            protected void addConstructExtras(com.koomplo.wizardry.api.content.spell.internal.CastContext ctx,
                                              com.koomplo.wizardry.content.entity.construct.ForcefieldConstruct construct,
                                              net.minecraft.core.Direction side) {
                construct.setRadius(property(DefaultProperties.EFFECT_RADIUS)
                        * ctx.modifiers().get(com.koomplo.wizardry.api.content.spell.internal.SpellModifiers.BLAST));
            }
        }.assignProperties(
                SpellProperties.builder()
        ...
        SUMMON_PHOENIX = spell("summon_phoenix", () -> new MinionSpell<>(com.koomplo.wizardry.content.entity.living.Phoenix::new).flying(true))
                .soundValues(1, 1.1f, 0.1f)
                .assignProperties(
                        SpellProperties.builder()
        ...
        SUMMON_IRON_GOLEM = spell("summon_iron_golem", () -> new MinionSpell<>(com.koomplo.wizardry.content.entity.living.SpectralGolem::new))
                .soundValues(1, 1.1f, 0.1f)
                .assignProperties(
                        SpellProperties.builder()
