package com.koomplo.wizardry.content.entity.goal;

import com.koomplo.wizardry.api.content.data.MinionData;
...
public class MinionFollowOwnerGoal extends Goal {
    ...
    private boolean canTeleportTo(BlockPos pos) {
        PathType blockpathtypes = WalkNodeEvaluator.getPathTypeStatic(this.minion, pos.mutable());
