...
public class FrostBarrier extends Spell {
    ...
    private boolean createBarriers(Level world, Vec3 origin, Vec3 direction, @Nullable LivingEntity caster, com.koomplo.wizardry.api.content.spell.internal.SpellModifiers modifiers) {
        if (!world.isClientSide) {
            ...
            int barrierCount = 1 + Math.max(1, (int) ((modifiers.get(com.koomplo.wizardry.api.content.spell.internal.SpellModifiers.POTENCY) - 1)
                    / com.koomplo.wizardry.core.config.EBServerConfig.POTENCY_INCREASE_PER_TIER.get() + 0.5f));
    ...
    private IceBarrierConstruct createBarrier(Level world, Vec3 centre, Vec3 direction, @Nullable LivingEntity caster, com.koomplo.wizardry.api.content.spell.internal.SpellModifiers modifiers, int barrierCount, int index) {
        ...
        barrier.lifetime = (int) (property(com.koomplo.wizardry.content.spell.DefaultProperties.DURATION)
                * modifiers.get(com.koomplo.wizardry.api.content.spell.internal.SpellModifiers.DURATION));
        barrier.damageMultiplier = modifiers.get(com.koomplo.wizardry.api.content.spell.internal.SpellModifiers.POTENCY);
    ...
    protected @NotNull SpellProperties properties() {
        return SpellProperties.builder()
                .assignBaseProperties(SpellTiers.APPRENTICE, Elements.ICE, SpellType.DEFENCE,
                        com.koomplo.wizardry.api.content.spell.SpellAction.SUMMON, 20, 0, 50)
                .add(com.koomplo.wizardry.content.spell.DefaultProperties.DURATION, 400)
                .build();
    }
}
