...
public final class EBRenderers {
    ...
    public static void createEntityLayers(BiConsumer<ModelLayerLocation, Supplier<LayerDefinition>> consumer) {
        ...
        consumer.accept(com.binaris.wizardry.client.model.HammerModel.LAYER_LOCATION, com.binaris.wizardry.client.model.HammerModel::createBodyLayer);
    }
    ...
    public static void registerRenderers() {
        ...
        registerEntityRender(EBEntities.LIGHTNING_DISC, (ctx -> new com.binaris.wizardry.client.renderer.entity.LightningDiscRenderer(ctx, WizardryMainMod.location("textures/entity/lightning_sigil.png"))));
