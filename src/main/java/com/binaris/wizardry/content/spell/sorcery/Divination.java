...
import com.binaris.wizardry.api.content.util.RelativeFacing;
...
public class Divination extends Spell {
    ...
    protected static float calculateWeight(Level world, Player caster, BlockPos pos, double range, com.binaris.wizardry.api.content.spell.internal.SpellModifiers modifiers) {
